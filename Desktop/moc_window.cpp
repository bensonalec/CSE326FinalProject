...
struct qt_meta_stringdata_notifList_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_notifList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_notifList_t qt_meta_stringdata_notifList = {
    {
QT_MOC_LITERAL(0, 0, 9) // "notifList"
...
static const uint qt_meta_data_notifList[] = {
...
void notifList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject notifList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_notifList.data,
      qt_meta_data_notifList,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *notifList::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *notifList::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_notifList.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int notifList::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    return _id;
}
...
QT_MOC_LITERAL(5, 29, 9) // "readNotif"
    ...
    "window\0closeTab\0\0i\0sendNotif\0readNotif"
};
#undef QT_MOC_LITERAL
